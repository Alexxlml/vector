...
@section('content')
    <div class="container d-flex flex-wrap justify-content-center align-items-center border border-secondary rounded">
        ...
        <div class="row d-flex justify-content-center py-4">
            <img src="{{ asset('images/logo.png') }}" alt="Logo" class="img-fluid" style="width: 65%">
        </div>
        ...
        <div class="card-deck py-4 row">
            ...
            <div class="card border-0">
                <div class="p-3 d-flex justify-content-center " style="background-color: #FFFFFF">
                ...
                <div class="card-body rounded text-white bg-danger border-danger">
                    ...
                    <p class="card-text text-center font-italic">Da clic en el botón buscar para acceder a la información
                        del colaborador</p>
                    {{-- <input type="text" name="" id="" placeholder="Número de colaborador"
                        class="ph-center form-control mb-4"> --}}
                    ...
                    {{-- Botón para ver el colaborador --}}

                    <a name="aColaborador" href="{{ url('empleado/consulta') }}"
                        class="btn btn-light d-flex justify-content-center">Buscar</a>
                </div>
            </div>
            ...
            <div class="card border-0">
                ...
                <div class="card-body rounded text-white bg-danger">
                    ...
                    <a name="aServicio" class="btn btn-light d-flex justify-content-center">Descargar</a>
                </div>
            </div>
